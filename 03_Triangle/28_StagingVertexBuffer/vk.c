...
VkResult createVertexBuffer(void)
{
	...
	vkBufferCreateInfo_stagingBuffer.flags = 0; //valid flags use in sparc buffer
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() - For Staging buffer vkCreateBuffer function failed  %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() -For Staging buffer vkCreateBuffer function Successed  \n");
	}
	...
	vkMemoryAllocateInfo_stagingBuffer.memoryTypeIndex = 0; // initial value before entrying in the loop
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() - For Staging buffer vkAllocateMemory function failed  %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() - For Staging buffer vkAllocateMemory function Successed  \n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() -For Staging buffer vkBindBufferMemory function failed  %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() -For Staging buffer vkBindBufferMemory function Successed  \n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() -For Staging buffer vkMapMemory function failed  %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() -For Staging buffer vkMapMemory function Successed  \n");
	}
	...
	//no need for memcpy(), vkUnmapMemory() for this device physible buffer
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createCommandBuffers() -for buffer copy vkAllocateCommandBuffers function failed  %d\n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createCommandBuffers() -for buffer copy vkAllocateCommandBuffers function Successed\n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "buildCommandBuffers() -for buffer copy vkBeginCommandBuffer function failed  %d\n", vkResult);
	}
	else
	{
		fprintf(gpFile, "buildCommandBuffers() -for buffer copy vkBeginCommandBuffer function Successed  \n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() -for buffer copy vkEndCommandBuffer function failed %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() -for buffer copy vkEndCommandBuffer function Successed  \n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() -for buffer copy vkQueueSubmit function failed  %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() -for buffer copy vkQueueSubmit function Successed  \n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "createVertexBuffer() -for buffer copy vkQueueWaitIdle function failed  %d \n", vkResult);
	}
	else
	{
		fprintf(gpFile, "createVertexBuffer() -for buffer copy vkQueueWaitIdle function Successed  \n");
	}
	...
	if (vkCommandBuffer) {
		...
		fprintf(gpFile, "createVertexBuffer() -vkCommandBuffer free Successfully \n");
	...
	if (vertexData_stagingBuffer_position.vkDeviceMemory)
	{
		...
		fprintf(gpFile, "\n createVertexBuffer()- vertexData_stagingBuffer_position.vkDeviceMemory destroy successed");
	}
	...
	if (vertexData_stagingBuffer_position.vkBuffer)
	{
		...
		fprintf(gpFile, "\n unintialize()- vertexData_stagingBuffer_position.vkBuffer destroy successed");
	}
	return vkResult;
}
...
VkResult createDescriptorSetLayout(void)
{
	...
	vkDescriptorSetLayoutCreateInfo.pBindings = NULL; //pBindings is actual array of VkDescriptorSetLayoutBinding
