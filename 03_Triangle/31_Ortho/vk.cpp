...
{  
	...
	glm::mat4 orthographicsProjectionMatrix = glm::mat4(1.0);
	if (winWidth <= winHeight)
	{
		orthographicsProjectionMatrix = glm::ortho(
			-100.0f,
			100.0f,
	...
	myUniformData.projectionMatrix = orthographicsProjectionMatrix;
