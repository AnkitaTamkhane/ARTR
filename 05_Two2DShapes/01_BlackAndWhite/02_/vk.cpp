...
VkResult inlitialize(void)
{
	...
	if (vkResult != VK_SUCCESS)
	{
		...
		fprintf(gpFile, " inlitialize() - createPipeline() function failed for triangle %d", vkResult);
		vkResult = VK_ERROR_INITIALIZATION_FAILED;
	}
	else
	{
		fprintf(gpFile, "inlitialize() - createPipeline() function Successed for triangle\n");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		...
		fprintf(gpFile, " inlitialize() - createPipeline() function failed for rectangle%d", vkResult);
		vkResult = VK_ERROR_INITIALIZATION_FAILED;
	}
	else
	{
		fprintf(gpFile, "inlitialize() - createPipeline() function Successed for rectangle\n");
	}
