...
VkResult inlitialize(void)
{
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "\ninlitialize() - getPhysicalDeviceSurfaceFormatAndColorSpace() function failed %d", vkResult);
	}
	else
	{
		fprintf(gpFile, "\ninlitialize() - getPhysicalDeviceSurfaceFormatAndColorSpace() function Successed");
	}
	...
	if (vkResult != VK_SUCCESS)
	{
		fprintf(gpFile, "\ninlitialize() - getPhysicalDevicePresentMode() function failed %d", vkResult);
	}
	else
	{
		fprintf(gpFile, "\ninlitialize() - getPhysicalDevicePresentMode() function Successed");
	}
	return vkResult;
}
